...
namespace Core.Rendering.Entities
{
    public class Texture : IDisposable
    {
        ...
        public void LoadTexture(string directory)
        {
            ...
            Bitmap? bitmap = Bitmap.FromFile(directory) as Bitmap;
            if (bitmap == null)
                return;
            ...
            unsafe
            {
                Colours = new Color4[bitmap.Width * bitmap.Height];
                ...
                switch (bitStep)
                {
                    case 4:
                        for (int x = 0; x < Width; x++)
                        {
                            ...
                            {
                                Colours[x + (Width * y)] = new Color4(src[0], src[1], src[2], src[3]);
                                src += bitStep;
                            }
                        }
                        break;
                    ...
                    case 3:
                        for (int x = 0; x < Width; x++)
                        {
                            for (int y = 0; y < Height; y++)
                            {
                                Colours[x + (Width * y)] = new Color4(src[0], src[1], src[2], 0);
                                src += bitStep;
                            }
                        }
                        break;
                    ...
                    case 2:
                        for (int x = 0; x < Width; x++)
                        {
                            for (int y = 0; y < Height; y++)
                            {
                                Colours[x + (Width * y)] = new Color4(src[0], src[1], 0, 0);
                                src += bitStep;
                            }
                        }
                        break;
                    ...
                    case 1:
                        for (int x = 0; x < Width; x++)
                        {
                            for (int y = 0; y < Height; y++)
                            {
                                Colours[x + (Width * y)] = new Color4(src[0], 0, 0, 0);
                                src += bitStep;
                            }
                        }
                        break;
        ...
        public void LoadTexture(int width, int height, int channels = 4)
        {
            ...
            unsafe
            {
                Colours = new Color4[Width * Height];
                ...
                switch (channels)
                {
                    case 4:
                        ...
                        {
                            for (int y = 0; y < Height; y++)
                                Colours[x + (Width * y)] = new Color4(0, 0, 0, 0);
                        }
                        break;
