...
namespace Core.Rendering.Entities
{
    public class Material : IDisposable
    {
        ...
        private readonly Dictionary<string, OpenTK.Mathematics.Half> uniformHalfs;
        ...
        public Material()
        {
            ...
            uniformHalfs = new Dictionary<string, OpenTK.Mathematics.Half>();
        ...
        public void SetUniform1(string name, OpenTK.Mathematics.Half value)
        {
            int uniformLocation = GL.GetUniformLocation(shader.ShaderID, name);
